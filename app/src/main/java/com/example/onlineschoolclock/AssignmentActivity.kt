...
class AssignmentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pickassigndate = findViewById<Button>(R.id.assignenterdate)
        val pickassigntime = findViewById<Button>(R.id.assignentertime)


        pickassigntime.setOnClickListener {
        ...
        pickassigndate.setOnClickListener {
